...
if __name__ == "__main__":
    ...
    print(
        "Enter your name as first message to register\nTo send a message to a particular username use '@username: message'.\nTo send message to everyone just type the message."
    )
    reactor.run()